class Money:
    def __init__(self, rub, kop):
        # Приводим копейки к нормальному виду (не более 99)
        total_kop = rub * 100 + kop
        self.rub = total_kop // 100
        self.kop = total_kop % 100
        # не учтены отрицательные суммы типа Money(-10. 50)!!!!!!!!!!!
    ...
    def __rmul__(self, other):
        # Для умножения числа на Money (2 * money_sum)
    ...
    def __str__(self):
        # Форматируем вывод: рубли и копейки
...
if __name__ == "__main__":
    ...
    print("Тест 2:", Money(-5, 150))  # -3руб 50коп //некорректные суммы -4р 50к
    print("Тест 3:", Money(-10, -50))  # -10руб -50коп //некорректные суммы -11р 50к
